...
# Física Ajustada (independente de Framerate)
@export var ACCELERATION = 2000.0
@export var MAX_SPEED = 300.0
@export var LIMIT_SPEED_Y = 1200.0
...
@export var WALL_SLIDE_FACTOR = 0.5
...
@onready var anim = $Rotatable/AnimatedSprite2D # <-- Substituto do AnimationPlayer
